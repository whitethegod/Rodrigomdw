            ...
            <div className="flex flex-col items-center justify-start relative md:mt-[90px] lg:mt-12 z-[20] w-auto h-auto">
                <InView triggerOnce={false}>
                    {({ inView, ref }) => (
                        ...
                        >
                            <img src="/rodrigo.jpg" alt="profile" width={250} />
                        </motion.div>
                    )}
                </InView>
                    ...
                    {({ inView, ref }) => (
                        ...
                        >
                            <h1 className="Welcome-text text-[16px] w-full text-justify">
                                Cyber Security Student at CODA - École d’informatique. 
                                Focused on Information Security and Systems Protection, with interests in Vulnerability Management, Network Security, and Security Operations (SecOps). 
                                Developing knowledge in areas such as Ethical Hacking, Web Application Security, Identity and Access Management (IAM), and Data Protection. Building a solid technical foundation in Threat Intelligence, Incident Response, and Penetration Testing to strengthen the resilience and security of modern digital environments.
                            </h1>
                        </motion.div>
                    )}
                </InView>
